...
export default function Contact() {
  return (
    <section id="contact" className="max-w-[700px] mx-auto px-6 py-24 text-center scroll-mt-20">
      <h2 className="text-3xl md:text-4xl font-bold text-accent-cyan mb-3 tracking-tight">
        Let&apos;s Connect
      </h2>

      <p className="text-foreground-secondary mb-10 text-sm md:text-base leading-relaxed">
